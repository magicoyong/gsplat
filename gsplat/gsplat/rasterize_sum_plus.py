...
class _RasterizeGaussiansSum(Function):
    ...
    def forward(
        ...
        if num_intersects < 1:
            ...
            rasterize_fn = _C.rasterize_sum_plus_forward #if not xy_norm else _C.project_gaussians_2d_covariance_norm_forward
    ...
    def backward(ctx, v_out_img, v_out_alpha =None):
        ...
        if num_intersects < 1:
            ...
            rasterize_fn = _C.rasterize_sum_plus_backward
